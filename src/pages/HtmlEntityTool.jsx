...
export default function HtmlEntityTool() {
    ...
    return (
        <>
            <SEO
                title="HTML Entity Encoder/Decoder - Convert HTML Entities | Free Tool"
                description="Free online HTML entity encoder and decoder. Convert special characters to HTML entities and vice versa."
